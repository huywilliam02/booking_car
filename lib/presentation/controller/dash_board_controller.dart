...
import 'package:citgroupvn_car/app/constant/show_toast_dialog.dart';
import 'package:citgroupvn_car/data/model/user_model.dart';
import 'package:citgroupvn_car/presentation/page/auth_screens/login_screen.dart';
import 'package:citgroupvn_car/presentation/page/contact_us/contact_us_screen.dart';
import 'package:citgroupvn_car/presentation/page/coupon_code/coupon_code_screen.dart';
import 'package:citgroupvn_car/presentation/page/dash_board.dart';
import 'package:citgroupvn_car/presentation/page/favotite_ride_screens/favorite_ride_screen.dart';
import 'package:citgroupvn_car/presentation/page/localization_screens/localization_screen.dart';
import 'package:citgroupvn_car/presentation/page/my_profile/my_profile_screen.dart';
import 'package:citgroupvn_car/presentation/page/new_ride_screens/new_ride_screen.dart';
import 'package:citgroupvn_car/presentation/page/privacy_policy/privacy_policy_screen.dart';
import 'package:citgroupvn_car/presentation/page/referral_screen/referral_screen.dart';
import 'package:citgroupvn_car/presentation/page/rent_vehicle_screens/rent_vehicle_screen.dart';
import 'package:citgroupvn_car/presentation/page/rented_vehicle.dart';
import 'package:citgroupvn_car/presentation/page/terms_service/terms_of_service_screen.dart';
import 'package:citgroupvn_car/presentation/page/wallet/wallet_screen.dart';
import 'package:citgroupvn_car/data/service/api.dart';
import 'package:citgroupvn_car/app/utils/Preferences.dart';
...
class DashBoardController extends GetxController {
  ...
  onSelectItem(int index) {
    if (index == 13) {
      LaunchReview.launch(
        androidAppId: "com.citgroupvn.car",
        iOSAppId: "com.citgroupvn.car.ios",
      );
    } else if (index == 14) {
