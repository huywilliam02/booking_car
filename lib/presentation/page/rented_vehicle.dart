...
import 'package:citgroupvn_car/presentation/controller/rented_vehicle_controller.dart';
import 'package:citgroupvn_car/data/model/rented_vehicle_model.dart';
...
class RentedVehicleScreen extends StatelessWidget {
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return buildVehicleCard(
                                context,
                                controller.rentedVehicleData[index],
                                controller);
                          }),
            ));
      },
  ...
  Widget buildVehicleCard(BuildContext context, RentedVehicleData data,
      RentedVehicleController controller) {
    return Card(
      elevation: 2,
