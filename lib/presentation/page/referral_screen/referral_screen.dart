...
import 'package:citgroupvn_car/presentation/controller/referral_controller.dart';
...
class _ReferralScreenState extends State<ReferralScreen> {
                            ...
                            child: DottedBorder(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                    ...
                                    child: Text(
                                      referralController.referralCode
                                          .toString(),
                                      textAlign: TextAlign.center,
                                      maxLines: 1,
  ...
  Future<void> share(ReferralController referralController) async {
    ...
    await FlutterShare.share(
      ...
      text:
          'Hey there, thanks for choosing citgroupvn_car. Hope you love our product. If you do, share it with your friends using code ${referralController.referralCode.toString()} and get ${Constant().amountShow(amount: referralController.referralAmount.toString())} when ride completed',
    );
  }
}
