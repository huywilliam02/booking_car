...
import 'package:citgroupvn_carwash/models/offer.dart';
import 'package:citgroupvn_carwash/screens/appointment_review.dart';
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () async {
                                  DateTime couponExpireDate =
                                      DateTime.parse(offers.expireDate!);
                                  DateTime now = DateTime.now();
                                  if (couponExpireDate.isAfter(now)) {
